<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShopShow(true)">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow(true)">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShopShow(false)">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="toggleShopShow(false)"></div>
      </div>
    </transition>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="toggleSupportShow(false)">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="activity-sheet-cover" @click="toggleSupportShow(false)"></div>
      </div>
    </transition>
  </div>
</template>
...
export default {
  ...
  methods: {
    toggleShopShow (isShow) {
      this.shopShow = isShow
    },
    toggleSupportShow (isShow) {
      this.supportShow = isShow
    }
  }
}
</script>
